...
├── js/wallpapers.js  # 预置壁纸库（46 款：导航主题 / 磨砂玻璃 / 柔光弥散 / 纯色 / 风景）
├── assets/wallpapers/ # 预置图片壁纸（28 张：导航主题 20 + 风景 8，含 CREDITS.json 注明来源）
...
- **⚙ 系统设置（右侧面板）**：站点图标（12 款内置矢量 + emoji / 自定义图片地址）、
  壁纸（46 款预置：导航主题 20 张高清成套装 + 磨砂/渐变/纯色/风景，另有在线壁纸库与本地上传，
  可调遮罩透明度与模糊）、
